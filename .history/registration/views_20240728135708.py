...
def progress(request):
    ...
    for goal in goals:
        ...
        # Append the goal's progress data to the list
    ...
    # Render the progress.html template with the progress data
    return render(request, 'registration/progress.html', {'progress_data': progress_data})