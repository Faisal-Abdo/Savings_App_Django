...
def contribute(request):
    ...
    goals = SavingsGoal.objects.filter(user=request.user)
    return render(request, 'authentication/contribute.html', {'form': form, 'goals': goals, 'contributions': contributions})
...
def goal_details(request, goal_id):
    ...
    return render(request, 'authentication/goal_details.html', {'goal': goal, 'contributions': contributions, 'total_contributed': total_contributed})